...
def main():
    ...
    input_size = 0x30; # Pick a max length for input, 0x20 is the minimum length
    ...
    for byte in argv1.chop(8):
        ...
        initial_state.add_constraints(byte <= '_') # \x5F
        initial_state.add_constraints(byte >= 'a') # \x61
    ...
    sm.explore(find=0x400a25, avoid=0x400af8,0x400a36)
